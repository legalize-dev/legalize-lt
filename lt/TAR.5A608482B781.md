...
Respublikos baudžiamuosius įstatymus. Jeigu asmuo, padaręs nusikaltimą užsienyje,
...
tarpvalstybinėmis sutartimis, o jeigu tokių sutarčių nėra - vadovaujantis Lietuvos
...
terorizavimas sunkinančiomis aplinkybėmis (227(2) straipsnio 2 dalis),
...
vartoti psichotropines ar narkotines medžiagas sunkinančiomis
...
įgijimas, gaminimas, realizavimas ir perdavimas sunkinančiomis aplinkybėmis
...
(2492 straipsnis), plėšimą sunkinančiomis aplinkybėmis (272
...
įstatymus toks asmuo, kuris, darydamas pavojingą visuomenei veiką, buvo nepakaltinamumo
...
padariusiam nusikaltimą, ir apribojanti nuteistojo teises bei laisves visuomenės
...
straipsnis), radioaktyviųjų medžiagų grobimą (234 straipsnis), orlaivio nuvarymą
...
baudos dydį, teismas atsižvelgia į padaryto nusikaltimo pavojingumą, nusikaltimu

padarytą žalą bei kaltininko materialinę padėtį.
...
3) kad nusikaltimas padarytas dėl savanaudiškų

ar kitokių žemų paskatų;
...
ar nepilnametystės negali būti paskirta įstatyme numatyta bausmė arba teisiamasis

ar jo išlaikomi asmenys serga sunkia liga ir nėra kam juos prižiūrėti arba

kaltininkas išlaiko mažamečius vaikus ir įstatyme numatytos bausmės paskyrimas

neigiamai atsilieps vaikų priežiūrai, arba kaltininko vaidmuo bendrininkų

padarytame nusikaltime buvo antraeilis.
...
baudžiamosios atsakomybės nustoja galioti ir sprendžiamas klausimas dėl tokio asmens

patraukimo baudžiamojon atsakomybėn už visas padarytas veikas.
...
atėmimo vietų taiko teismas tos vietos, kur nuteistasis atlieka bausmę, pagal organo.
...
atėmimu iki penkerių metą įskaitytinai už nusikaltimus, padarytus dėl
...
paleisti iš laisvės atėmimo vietų, per penkiolika dieną nuo paleidimo momento privalo
...
valstybinio herbo ar valstybinės vėliavos nuplėšimas, sudraskymas, sulaužymas, sunaikinimas,

subjaurojimas ar kitoks išniekimas, taip pat viešas pasityčiojimas iš Lietuvos

Respublikos valstybinio himno -
...
200 straipsnis. Privertimas valdžios

ar visuomenės atstovo atlikti
...
straipsnis. Įžeidimas valdžios ar visuomenės atstovo
...
policijos rėmėjo ryšium su jiems pavestą viešosios tvarkos saugojimo pareigą ėjimu
...
muitinės deklaracijos, mokesčio sumokėjimą patvirtinančio arba kito itin svarbaus
...
224 straipsnis. Jūrų telegrafo

kabelio sužalojimas dėl neatsargumo
...
Draudžiamų auginti opijaus aguonų,

taip pat indiškų, Pietų Mandžiūrijos, Pietų Čiujaus, Pietų Archonos ir Pietų
...
mišiniai bei atliekos išverčiamos siekiant palaidoti jūroje, - ir organizacijai,
...
taisyklių pažeidimas, pasireiškęs mušimu ar kitokiu smurtu, nepavojingu nukentėjusiojo
...
pagrobimas laikomas stambiu, jeigu pagrobtojo ar reikalaujamo perduoti turto vertė

viršija 250 minimalių gyvenimo lygių (MGL) dydžio sumą arba pagrobtas
...
baudžiamas bauda su atėmimu teisės

eiti tam tikras pareigas ar dirbti tam tikrą darbą arba užsiimti tam tikra

veikla iki penkerių metų arba be tokios teisės atėmimo.
...
Išlaisvinimas sulaikyto, suimto

ar atliekančio laisvės atėmimo bausmę asmens, padarytas panaudojus smurtą,

apgaulę arba piktnaudžiaujant pasitikėjimu, -
...
apskaitos tvarkymas arba apskaitos dokumentų neišsaugojimas, jeigu dėl to nebuvo

galima visiškai ar iš dalies nustatyti įmonės veiklos, komercinės, ūkinės,
